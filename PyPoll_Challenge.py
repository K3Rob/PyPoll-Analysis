...
with open(file_to_save, "w") as txt_file:
    ...
    for county_list in county_votes:
        ...
        county_vote= county_votes[county_list]

        # 6c: Calculate the percentage of votes for the county.
        county_percent = county_vote/ total_votes *100

         # 6d: Print the county results to the terminal.
        county_results = (f"{county_list}:{county_percent:.1f}%({county_vote:,})\n")
        ...
        if county_vote >= largest_turnout:
            ...
            county_turnout = county_list

    # 7: Print the county with the largest turnout to the terminal.
    county_w_largest_turnout = ( 
        f"\n"
        f"-------------------------\n"
        f"Largest County Turnout: {county_turnout:}\n"
        f"-------------------------\n\n")
        
    print(county_w_largest_turnout, end="")     

    # 8: Save the county with the largest turnout to a text file.
    txt_file.write(county_w_largest_turnout)
